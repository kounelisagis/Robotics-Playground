...
# graphics.record_video("gravity_compensation_controller.mp4")
...
while error > 1e-2:
    ...
    cmd = jac_pinv @ PID + robot.gravity_forces(dofs)
...
plt.plot(errors, '-')
plt.title("Gravity Compensation Controller | Kp = {}, Ki = {}, Kd = {}".format(Kp, Ki, Kd))
plt.xlabel("timestep")
plt.ylabel("error")
plt.show()
